...
export async function POST(request){
  ...
  try{
    ...
    console.error('Participant registration request failed:',error);const response=NextResponse.json({ok:true,message:GENERIC_LOGIN_MESSAGE});response.cookies.set(CHALLENGE_COOKIE,`AUTH-DECOY-${opaqueToken()}`,cookieOptions(10*60));return response;
  }
}
