...
export function logServerFailure(operation,error){const code=SAFE_CODES.has(error?.code)?error.code:'INTERNAL_FAILURE';console.error(JSON.stringify({operation,code}));}
